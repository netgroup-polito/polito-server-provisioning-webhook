...
async def handle_webhook(
    ...
    # --- EVENTO DELETED (Pulizia Condizionale) ---
    elif payload.event_type == EVENT_DELETED:
        ...
        # Ora leggiamo direttamente dal payload piatto
        now = utils.parse_timestamp(payload.timestamp)
        start = utils.parse_timestamp(payload.event_start)
        end = utils.parse_timestamp(payload.event_end)
