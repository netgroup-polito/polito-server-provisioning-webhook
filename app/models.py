...
class WebhookPayload(BaseModel):
    """
    Model for webhook event payload (EVENT_START / EVENT_END / EVENT_DELETED).
    ...
    event_type: str = Field(..., alias='eventType', description="Type of the event (EVENT_START, EVENT_END, EVENT_DELETED)")
